 ...
 * */
	...
	public User(int idx, String id, String name, String phone, char verify, Date regdate,
			char out) {
		this.idx = idx;
		this.id = id;
		this.name = name;
	...
	public User(int idx, String id, String pw, String name, String phone, String code, char verify, Date regdate,
			char out) {
		this.idx = idx;
		this.id = id;
		this.pw = pw;
